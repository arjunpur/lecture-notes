...
\textit{A neural network is useless without a rule for setting its weights. This chapter introduces the Hebbian learning rule, analyzes the capacity of a single perceptron as an associative memory, and then asks how sparse coding can dramatically increase storage in a network with binary synapses.}
