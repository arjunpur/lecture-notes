...
\textit{The analytical solutions of cable theory apply only to passive, uniform cables. Real neurons have complex morphologies and nonlinear channels. This chapter introduces the compartmental method for numerical simulation, analyzes action potential propagation along axons, and shows how myelination dramatically increases conduction velocity.}
