...
\textit{How does the visual cortex represent the world? This chapter develops the linear filter model of simple cells, shows why a Gabor function captures their spatial tuning, and explains how complex cells achieve phase invariance through the energy model. The key distinction is between separable and non-separable space-time receptive fields, which determines whether a neuron can detect motion direction.}
