...
\textit{Voltage dynamics become spiking dynamics only after conductances are allowed to change and thresholds are imposed. This chapter moves from ion channels to the leaky integrate-and-fire model and its basic synaptic extensions.}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figures/mns-lif-fi.png}
\caption{Leaky integrate-and-fire dynamics. Subthreshold voltage relaxes exponentially toward a current-dependent fixed point, while threshold and reset convert that relaxation into spikes; the firing-rate curve is the inverse interspike interval.}
\label{fig:lif-fi}
\end{figure}
