...
\textit{One-dimensional systems cannot oscillate. To understand repetitive firing, we need at least two dimensions---typically voltage and a recovery variable. This chapter develops the tools of two-dimensional phase-plane analysis: vector fields, nullclines, fixed point classification via the Jacobian, and limit cycles.}
