...
\textit{Single neurons compute, but brains are networks. This chapter develops the firing-rate model of neural populations, analyzes linear recurrent networks using eigenmode decomposition, and shows how recurrent connectivity can amplify, select, and sustain patterns of activity. The ring network for head-direction coding illustrates these principles in a concrete biological setting.}
