...
\textit{Once the cable equation is available, geometry becomes the next control variable. This chapter studies time dependence, branch points, and Rall's equivalent cylinder as a compact summary of dendritic trees.}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figures/mns-rall-branching-attenuation.png}
\caption{Branching cable geometry. Rall's $3/2$ law impedance-matches a branched tree to an equivalent cylinder, while impedance mismatch explains why distal-to-soma and soma-to-distal signals attenuate differently.}
\label{fig:rall-branching-attenuation}
\end{figure}
