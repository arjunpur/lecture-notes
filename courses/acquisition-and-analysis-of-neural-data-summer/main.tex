...
\subsection{Reserved lecture section}

This section is reserved for the second lecture in the \emph{Acquisition and Analysis of Neural Data} notes. It is intentionally present now so the notes grow lecture-by-lecture, rather than treating the first lecture as if it were a full chapter block.

\subsection{Planned expansion}

Once the Lecture 2 slide deck is available, this section will be expanded into full notes with its own nested subsections, figures, and references, following the same lecture-level structure now used for Lecture 1.
