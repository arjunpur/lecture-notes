...
Principal Component Analysis (PCA), also known as the Karhunen--Loeve transform, is the first projection method in Machine Intelligence II \parencite{jolliffe2002principal,bishop2006pattern}. The problem starts with observations
\[
...
\section{Projection Methods and Data Structure}
...
\begin{aside}[From raw variables to directions]
...
\section{Moments of the Data Cloud}
...
\section{Variance Along a Complex Feature}
...
\begin{keyequation}[PCA eigenproblem]
\[
  Ce_a = \lambda_a e_a,
  \qquad
...
\section{Properties of Principal Components}
...
\subsection{Optimal Linear Dimensionality Reduction}
...
\subsection{Leptograpsus Crab Measurements}
...
\section{Computational Notes and Extensions}
